...
Pseudotime.genes.clusters <- cluster::pam(as.dist((1 - cor(Matrix::t(CR_curve_matrix),method = "spearman"))), k= 5)

Gene.dynamique <- data.frame(Gene= names(Pseudotime.genes.clusters$clustering),
...
Gene.dynamique$Gene.Clusters <- paste0("Clust.",Gene.dynamique$Gene.Clusters)
```
