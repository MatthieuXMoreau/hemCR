...
write.table(pseudo.maturation.diff, "CR_dynamic_genes_unfiltered.csv", sep = ";", quote = F, row.names = F)
```
...
ggsave("~/Bureau/Fig4_MM/Heatmap_WT-CR.pdf",
       width = 15, height = 9,
       device = "pdf",
       dpi = "retina")
```
...
ggsave("~/Bureau/Fig4_MM/WT-CR_Cluster_trend.pdf",
       width = 15, height = 9,
       device = "pdf",
       dpi = "retina")
```
