...
```{r}
p1 <- ggplot(WT_CR@meta.data, aes(Spring_1, Spring_2, color= Pseudotime.bins)) + geom_point()
p2 <- ggplot(KO_CR@meta.data, aes(Spring_1, Spring_2, color= Pseudotime.bins)) + geom_point()
p3 <- ggplot(WT_Pal@meta.data, aes(Spring_1, Spring_2, color= Pseudotime.bins)) + geom_point()
p4 <- ggplot(KO_Pal@meta.data, aes(Spring_1, Spring_2, color= Pseudotime.bins)) + geom_point()
...
ggplot(data, aes(x= Pseudotime.bin, y= Distance, color= Trajectory, group = Trajectory)) +
  geom_line() +
  geom_point() + ggtitle("Euclidian distance to KO pallial neurons")
...
WT_CR.dist <- 1 - diag(Smoothed.point.cor$cosine)
...
KO_CR.dist <- 1 - diag(Smoothed.point.cor$cosine)

#
Smoothed.point.cor <- cosMat(WT_Pal.averages$RNA,
                             KO_Pal.averages$RNA)

KO_Pal.dist <- 1- diag(Smoothed.point.cor$cosine)
```
...
ggplot(data, aes(x= Pseudotime.bin, y= Distance, color= Trajectory, group = Trajectory)) +
  geom_line() +
  geom_point() + ggtitle("Cosine distance to KO pallial neurons")

```

# Cosine to WT pallial neurons
...
#
Smoothed.point.cor <- cosMat(KO_Pal.averages$RNA,
                             WT_Pal.averages$RNA)
...
ggplot(data, aes(x= Pseudotime.bin, y= Distance, color= Trajectory, group = Trajectory)) +
  geom_line() +
  geom_point() + ggtitle("Cosine distance to WT pallial neurons")
