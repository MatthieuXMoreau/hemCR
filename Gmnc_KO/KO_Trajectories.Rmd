...
DimPlot(object = KO,
        group.by = "Cell.ident",
        reduction = "spring",
        cols = c( "#4cabdc", "#7293c8", "#3ca73f",
                  "#31b6bd","#a9961b", "#ebcb2e", "#9ec22f", 
                  "#e7823a"),
        pt.size = 0.5)  & NoAxes()
```
...
# Differentiating neurons pseudotime
...
```{r fig.dim=c(9,10)}
Trajectories.neurons <- Neurons.data@meta.data %>% select(Barcodes, nUMI, Spring_1, Spring_2,
