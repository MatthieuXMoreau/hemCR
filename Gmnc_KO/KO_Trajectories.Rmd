...
KO <- readRDS("./GmncKO.progenitors_prohected.RDS") %>% subset(idents = c(0,1,2,3,4))
```
...
```{r}
MCC.genes <- list(c("Trp73", "Gmnc", "Foxj1", "Myb", "Ccno", "Ccdc67", "Mcidas",
...
```{r}
p2 + p4 + p1 + p3 + patchwork::plot_layout(ncol = 2)
```
# Find DEG along the mutant tajectories
